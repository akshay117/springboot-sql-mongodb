...
public class ProductEntity {
  ...
  public ProductEntity(String name, String description, float price, List<String> images,
      SellerEntity seller, Set<CategoryEntity> fallIntoCategories) {
    this.name = name;
  ...
  public void setFallIntoCategories(
      Set<CategoryEntity> fallIntoCategories) {
    this.fallIntoCategories = fallIntoCategories;
  }
}
